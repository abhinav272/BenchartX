...
fun computePointLocation(
    ...
    val dx = index.toFloat() / (points.size - 1)
...
fun computeLinePath(
    ...
    var prePointLocation: Offset? = null
        points.forEachIndexed { index, point ->
            withProgress(index, points, transitionProgress) { progress ->
                val pointLocation = computePointLocation(drawableArea, lineChartData, points, point, index)
                if (index == 0) {
